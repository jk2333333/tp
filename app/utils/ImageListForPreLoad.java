...
public class ImageListForPreLoad {
	...
	public static Set<String> getImageListForPreLoad() {
		...
		// UI Elements
		images.add("assets/GameUtils/extra/battlemap6_middleground.png");
		images.add("assets/GameUtils/extra/AttackCircle.png");
		images.add("assets/GameUtils/extra/HealthCircle.png");
		images.add("assets/GameUtils/extra/GreyCircle.png");
		images.add("assets/GameUtils/extra/ManaCircle.png");
		images.add("assets/GameUtils/extra/ui/icon_mana.png");
		images.add("assets/GameUtils/extra/ui/icon_mana_inactive.png");
		images.add("assets/GameUtils/extra/ui/notification_quest_small.png");
		images.add("assets/GameUtils/extra/ui/general_portrait_image_hex_f1-third@2x.png");
		images.add("assets/GameUtils/extra/ui/general_portrait_image_hex_f4-third@2x.png");
		images.add("assets/GameUtils/extra/ui/tooltip_left@2x.png");
		images.add("assets/GameUtils/extra/ui/tooltip_right@2x.png");
		images.add("assets/GameUtils/extra/ui/button_end_turn_enemy.png");
		images.add("assets/GameUtils/extra/ui/button_primary.png");
